...
// eslint-disable-next-line @typescript-eslint/no-unused-vars
  ...
  const handleSendMessage = async (content: string = inputText, files: UploadedFile[] = uploadedFiles, messageId?: number) => {
    ...
    try {
      ...
      const response = await axios.post('https://scio-plan-backend.onrender.com/chat', formData, {
        headers: {
  ...
  const fetchSchedule = async () => {
    try {
      const response = await axios.post('https://scio-plan-backend.onrender.com/get_schedule', null, {
        headers: {
